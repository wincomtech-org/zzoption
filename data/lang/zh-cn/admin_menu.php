<?php
return array (
  'ADMIN_ACTION_CLEAR' => '清空系统任务',
  'ADMIN_ACTION_INDEX' => '管理员操作记录',
  'ADMIN_BANNER_ADD' => 'Banner图添加',
  'ADMIN_BANNER_ADDPOST' => 'Banner图添加1',
  'ADMIN_BANNER_DELETE' => 'Banner图删除',
  'ADMIN_BANNER_EDIT' => 'Banner图编辑',
  'ADMIN_BANNER_EDITPOST' => 'Banner图编辑1',
  'ADMIN_BANNER_INDEX' => 'Banner图管理',
  'ADMIN_CONFIG_EDITPOST' => '网站配置编辑1',
  'ADMIN_CONFIG_INDEX' => '网站配置',
  'ADMIN_COUNT_DEFAULT' => '数据统计',
  'ADMIN_COUNT_INDEX' => '12月统计',
  'ADMIN_COUNT_SEARCH' => '统计查询',
  'ADMIN_GUIDE_ADD' => '协议手册添加',
  'ADMIN_GUIDE_ADDPOST' => '协议手册添加1',
  'ADMIN_GUIDE_DELETE' => '协议手册删除',
  'ADMIN_GUIDE_EDIT' => '协议手册编辑',
  'ADMIN_GUIDE_EDITPOST' => '协议手册编辑1',
  'ADMIN_GUIDE_INDEX' => '协议手册管理',
  ...
  'ADMIN_LOG_CLEAR' => '日志清空',
  'ADMIN_LOG_DOWNLOAD' => '日志下载',
  ...
  'ADMIN_PAPER_DEFAULT' => '借款管理',
  'ADMIN_PAPER_EDIT' => '未完成借款查看',
  'ADMIN_PAPER_EDITPOST' => '未完成借款编辑执行',
  'ADMIN_PAPER_INDEX' => '未完成借款列表',
  'ADMIN_PAPER_INFO' => '未完成借款查看',
  'ADMIN_PAPEROLD_EDIT' => '已完成借款查看',
  'ADMIN_PAPEROLD_EDITPOST' => '已完成借款编辑执行',
  'ADMIN_PAPEROLD_INDEX' => '已完成借款列表',
  ...
  'ADMIN_REPLY_EDIT' => '借款申请查看',
  'ADMIN_REPLY_EDITPOST' => '借款申请编辑执行',
  'ADMIN_REPLY_INDEX' => '借款申请列表',
  ...
  'ADMIN_SQL_ADD' => '数据库备份',
  'ADMIN_SQL_DEL' => '数据库删除备份',
  'ADMIN_SQL_DELS' => '数据库批量删除备份',
  'ADMIN_SQL_INDEX' => '数据库操作',
  'ADMIN_SQL_QUERY' => ' 数据库查询',
  'ADMIN_SQL_RESTORE' => '数据库还原',
  ...
  'USER_ADMININDEX_EDITPOST' => '用户详情执行',
  'USER_ADMININDEX_INDEX' => '本站用户',
  'USER_ADMININDEX_INFO' => '用户详情',
